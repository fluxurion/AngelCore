...
const uint32 CMSG_GET_DECOR_REFUND_LIST                            = 0x290031;
const uint32 CMSG_GET_ALL_LICENSED_DECOR_QUANTITIES                = 0x290034;
const uint32 CMSG_COMMERCE_TOKEN_GET_MARKET_PRICE                  = 0x400115;
const uint32 CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY                 = 0x400118;
const uint32 SMSG_GET_DECOR_REFUND_LIST_RESPONSE                   = 0x420375;
const uint32 SMSG_GET_ALL_LICENSED_DECOR_QUANTITIES_RESPONSE       = 0x42037A;
const uint32 SMSG_COMMERCE_TOKEN_GET_MARKET_PRICE_RESPONSE         = 0x42027B;
const uint32 SMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY_RESPONSE        = 0x42027F;
